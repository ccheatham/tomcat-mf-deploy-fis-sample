package com.mf_rpc_sdk.openlegacy.config;
 ...
 */
@Configuration
public class MfRpcSdkConfiguration {
    private static final String ORCHESTRATED_KEY = "mfRpcSdk";
    private static final String[] packagesToScan = new String[] {"com.mf_rpc_sdk.openlegacy"};
