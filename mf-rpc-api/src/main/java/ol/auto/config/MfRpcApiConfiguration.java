...
*/
@Configuration
public class MfRpcApiConfiguration extends OLCommonBasicConfiguration {

    private static final String[] servicesPackages = new String[] {"com.mf_rpc_api.openlegacy.services"};
